...
const ClientPage = ({ topicName, initialData }: ClientPageProps) => {
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center min-h-screen bg-grid-zinc-50 pb-10">
      <MaxWidthWrapper className="flex flex-col items-center gap-6 pt-14">
        <h1 className="text-4xl sm:text-5xl font-bold text-center tracking-tight text-balance">
          What people think about{" "}
          <span className="text-blue-700">{topicName}</span>
        </h1>

        <p className="text-sm">(updated in real-time)</p>

        <ScrollArea className="aspect-square max-w-xl w-full flex items-center justify-center max-h-[60vh]">
          <Wordcloud
            words={words}
            width={500}
            height={500}
